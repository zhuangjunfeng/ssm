...
public class NewsContorller {
    ...
    @ResponseBody
    public JSONResult addNews(HttpServletRequest request,HttpServletResponse response){
        JSONResult result;
    ...
    @ResponseBody
    public JSONResult delNewsById(HttpServletRequest request,HttpServletResponse response){
    ...
    @ResponseBody
    public JSONResult updateNews(HttpServletRequest request,HttpServletResponse response)
    {
        JSONResult result;
        int newsId=Integer.parseInt(request.getParameter("newsId"));
        String newsType = request.getParameter("newsType");
    ...
    @ResponseBody
    public JSONResult findNewsById(HttpServletRequest request,HttpServletResponse response){
        JSONResult result;
        int newsId=Integer.parseInt(request.getParameter("newsId"));
